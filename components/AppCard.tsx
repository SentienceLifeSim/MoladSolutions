...
export default function AppCard({
  ...
  return (
    ...
    >
      ...
      {comingSoon ? (
        <div className="mt-auto inline-flex items-center gap-2 px-6 py-3 rounded-full bg-white/5 border border-white/15 text-white/35 text-sm font-medium cursor-default select-none">
